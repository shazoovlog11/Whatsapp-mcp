...
export class ResourceHandler {
  ...
  private async getStatusResource(uri: string) {
  ...
  private async getChatsResource(uri: string) {
    let chats: any[] = [];
  ...
  private async getContactsResource(uri: string) {
    let contacts: any[] = [];
  ...
  private async getGroupsResource(uri: string) {
    let groups: any[] = [];
  ...
  private async getChatResource(uri: string, chatId: string) {
    let messages: any[] = [];
