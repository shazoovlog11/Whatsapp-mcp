        ...
        return [
            {
                ...
                description: "A helpful WhatsApp assistant that can send messages, manage groups, and more",
                arguments: [
                    {
                        name: "task",
            ...
            },
            {
                ...
                arguments: [
                    {
                        name: "action",
                        description: "Action to perform (create, info, add_members, etc.)",
                        required: true,
                    },
                ],
            },
            ...
            },
            {
                ...
                description: "Set up automated responses for WhatsApp messages",
                arguments: [
                    {
                        name: "trigger",
